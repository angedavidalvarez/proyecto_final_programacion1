...
public:
	...
	void crear() {
		...
		if (cn.getConectar()) {
			...
			string gen;
			string  nombres, apellidos, correo_electronico, fecha_ingreso, fecha_nacimiento,fecha_inicio, direccion;
			int genero, nit, telefono, dpi, id_puesto;
			...
			string insert = "INSERT INTO `almacen`.`empleados`(`nombre`,`apellido`,`direccion`,`telefono`,`dpi`,`genero`,`fecha_nacimiento`,`idpuesto`,`fecha_inicio_labores`,`fechaingreso`) VALUES('" + nombres + "', '" + apellidos + "', '" + direccion + "', '" + t + "', '" + DPI + "', " + gen + ", '" + fecha_nacimiento + "', '" + puesto + ", '" + fecha_inicio + "', current_time());";
